...
export const getCesubofferTabs = (aFormsTabs) => (dispatch) => {
  const cesubtabs = aFormsTabs.reduce((obj, option) => {
...
export const getCesubofferSlots = (aFormsSlots) => (dispatch) => {
  const cesubslots = aFormsSlots.reduce((obj, option) => {
