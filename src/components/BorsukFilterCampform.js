...
import { BorsukFilterCampformStyle } from './BorsukFilterCampformStyle.js';
...
export class BorsukFilterCampform extends connect(store)(LitElement) {
    static get styles() {
        return [BorsukFilterCampformStyle];
    }
        ...
        return html`
            ...
            <filter-collapse id="filterContentCollapse" @click=${this.isCollapsed}>
                <div class="formGrid formGrid12">
                    ...
                    <div class="inputGrid formGrid12 formSpanGrid4">
                        <paper-input 
                            type="text"
                    ...
                    <div class="inputGrid formSpanGrid12 checkboxContener">
                        <div class="flexbuttons">
                            ...
                            <borsuk-button wide white @click="${this.filterReset}">Pokaż tylko moje</borsuk-button>
                        </div>
                    </div>
                </div>
            </filter-collapse>
