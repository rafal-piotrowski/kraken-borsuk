...
import { dictEventsSelector, dictPersLevelSelector, dictEmployeeSelector } from '../../../redux/reducers/dictionaries.js';
...
export class BorsukGroupPatternForm extends connect(store)(LitElement) {
    static get styles() {
