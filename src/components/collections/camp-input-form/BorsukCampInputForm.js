                        ...
                        return html`
                            ...
                            <div class="inputGrid inputFrame formSpanGrid12 formBorder formBottomShadow">
                                <borsuk-input
                                    ...
                                    label="Zgłaszający akcję">
                                        <div slot="help-text">Nazwa użytkownika zgodna z CKey</div>
                                        <div slot="prefix">PF83WS</div>
                                </borsuk-input>
                            </div>
                            ...
                            <div class="inputGrid inputFrame formSpanGrid12 formBorder formBottomShadow">
                                <borsuk-input
                                    class="input90"
                                    label="Nazwa akcji">
                                        <div slot="help-text">Wprowadź nazwę akcji</div>
                                        <div slot="prefix" style="color: red;">*</div>
                                </borsuk-input>
                            </div>
                            ...
                            <div class="inputGrid inputFrame formSpanGrid6 formBorder formBottomShadow">
                                <borsuk-select
                                    ...
                                    <div slot="help-text">Wybierz z listy</div>
                                    <select slot="input">
                            ...
                            <div class="inputGrid inputFrame formSpanGrid12 formBorder formBottomShadow">
                                <borsuk-button gap id="attachmentButton">Załącznik</borsuk-button>
                            </div>
                            ...
                            <div class="inputGrid inputFrame formSpanGrid12 formBorder formBottomShadow">
                                <borsuk-input
                                    class="input90"
                                    label="ING Campaign">
                                        <div slot="help-text">Wprowadź nazwę kampanii</div>
                                </borsuk-input>
                            </div>
                            ...
                            <div class="inputGrid inputFrame formSpanGrid12 formBorder formBottomShadow">
                                <borsuk-input
                                    class="input90"
                                    label="ING Campaign">
                                        <div slot="help-text">Warunki obligatoryjne</div>
                                        <div slot="prefix" style="color: red;">*</div>
                                </borsuk-input>
                            </div>
