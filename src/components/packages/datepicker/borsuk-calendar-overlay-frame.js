...
import { IngDialogFrame } from '../dialog/IngDialogFrame.js';
import { breakpoint600 } from '../../../styles/values/breakpoints.js';
import { spacer4 } from '../../../styles/values/spacing.js';
import { font19BoldMixin } from '../../../styles/mixins/typography.js';
...
*/
export class BorsukCalendarOverlayFrame extends IngDialogFrame {
  static get styles() {
    return [
      super.styles,
      css`
...
customElements.define('borsuk-calendar-overlay-frame', BorsukCalendarOverlayFrame);
